# IBANAPI OpenApi Documentation MCP Server

This MCP (Model Content Protocol) server provides access to IBANAPI OpenApi Documentation API functionality through HTTP, HTTPS, and STDIO transport modes.
